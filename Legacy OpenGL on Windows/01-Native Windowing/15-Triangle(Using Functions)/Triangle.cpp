...
void glDrawMultipleParallelLines(GLint flag)
{
...
void glDrawHorizontals()
{
	...
	glDrawMultipleParallelLines(HORIZONTAL);
}
...
void glDrawVerticals()
{
	...
	glLineWidth(1.0f);
	glColor3f(0.0f, 0.0f, 1.0f);
	glDrawMultipleParallelLines(VERTICAL);
}
...
void glDrawTriangle()
{
	...
	glDrawLine(0.0f,0.5f,0.0f,-0.5f,-0.5f,0.0f);
	glDrawLine(0.0f, 0.5f, 0.0f, 0.5f, -0.5f, 0.0f);
