...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int nCmdShow)
{
	...
	hWnd = CreateWindowEx(WS_EX_APPWINDOW,
		szClassName,
		TEXT("OpenGL Native Windowing : Programmable Pipeline : 2 2D Shapes Colored"),
...
void initialize(void)
{
	...
	glBindVertexArray(gVao_triangle);//Bind to the Vertex Array Object
	...
	glVertexAttrib3f(YDK_ATTRIBUTE_COLOR, 0.0f, 0.0f, 1.0f);
	//glEnableVertexAttribArray(YDK_ATTRIBUTE_COLOR);
